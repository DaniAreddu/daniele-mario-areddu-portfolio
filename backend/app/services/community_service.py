...
def to_community_activity_out(activity: CommunityActivity, locale: str) -> CommunityActivityOut:
...
class CommunityService:
    ...
    async def get_profile(self, locale: str) -> CommunityProfileOut:
        ...
        return CommunityProfileOut(
            ...
            activities=[
                to_community_activity_out(activity, locale) for activity in activities
            ],
        )
